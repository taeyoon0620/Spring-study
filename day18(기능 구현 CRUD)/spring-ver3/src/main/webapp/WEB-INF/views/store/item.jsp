		...
		<div class="container">
            ...
            <use xlink:href="#bootstrap" />
				...
				<ul
					...
					<li><a href="${context}store/items"
						class="nav-link px-2 text-white">상품 목록</a></li>
					<li><a href="${context}store/items/add"
						class="nav-link px-2 text-white">상품 등록</a></li>
				</ul>
		...
		<div class="row my-2">
			...
			<div class="col">
				<input type="text" id="price" name="price" class="form-control"
					value="${item.price}" disabled readonly>
			</div>
		</div>
		...
		<div class="row my-2">
			...
			<div class="col">
				<input type="text" id="quantity" name="quantity"
					class="form-control" value="{item.quantity}" disabled readonly>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col d-grid">
				<button type="button" class="btn btn-secondary btn-lg"
					onclick="location.href='${context}/store/items/1/${item.id}edit'">상품
					수정</button>
			</div>
		</div>
	</div>
