...
<body>
  ...
  <div class="container" style="max-width: 600px;">
    ...
    <div class="row my-2">
      ...
      <div class="col">
        <input type="text" id="id" name="id" class="form-control" value="1" disabled readonly >
      </div>
    </div>
    ...
    <div class="row my-2">
      ...
      <div class="col">
        <input type="text" id="name" name="name" class="form-control" value="새우깡" disabled readonly > 
      </div>
    </div>
    ...
    <div class="row my-2">
      ...
      <div class="col">
        <input type="text" id="price" name="price" class="form-control" value="1500" disabled readonly >  
      </div>
    </div>
    ...
    <div class="row my-2">
      ...
      <div class="col">
        <input type="text" id="quantity" name="quantity" class="form-control" value="10" disabled readonly > 
      </div>
    </div>
    ...
    <div class="row">
        ...
        <div>
          <button type="button" class="btn btn-secondary w-100 btn-lg"
            onclick="location.href='${context}/store/items/1/edit'">상품 수정</button>
